...
/*******************************************************************************
* Function Name: wait_for_pending_prints
****************************************************************************//**
** Summary:
* Wait for UART operation to be completed
*
* Parameters:
*  void
*
...
{
    while(mtb_hal_uart_is_rx_active(&DEBUG_UART_hal_obj) || mtb_hal_uart_is_tx_active(&DEBUG_UART_hal_obj))
    {
        //do nothing
    }
}
