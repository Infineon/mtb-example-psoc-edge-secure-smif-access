...
The following example clones the "[Secure SMIF access](https://github.com/Infineon/mtb-example-psoc-edge-secure-smif-access)" application with the desired name "SecureSmifAccess" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-secure-smif-access --user-app-name SecureSmifAccess --target-dir "C:/mtb_projects"
   ```
